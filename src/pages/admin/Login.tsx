ini admin layout saya tiap klik logout gabisa tetap di halaman dashboard 
...
dan admin login saya  ini


saya punya admin login gini 
tapi gabisa logout
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-800 font-medium mb-2">PERINGATAN KEAMANAN....!!!:</p>
            <div className="text-xs text-blue-700 space-y-1">
              <P> Halaman Admin Hanya Bisa Diakses Oleh Yang Berwenang !</P>
            </div>
          </div>
        </div>
